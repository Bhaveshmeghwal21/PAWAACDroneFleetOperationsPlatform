/**
 * Redis connectivity for the Alert & Notification service.
 *
 * Redis backs escalation timers and rule/alert state (sorted sets + Lua scripts
 * in later tasks). This module only establishes a shared, injectable `ioredis`
 * client and exposes it for readiness checks; it does NOT implement any
 * escalation logic yet.
 */
import {
  Global,
  Logger,
